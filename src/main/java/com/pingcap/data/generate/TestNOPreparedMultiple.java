...
public class TestNOPreparedMultiple {
    ...
    public static void main(String[] args) throws Exception {
        parseArgs(args);
        List<String> data = new TestNOPreparedMultiple().getTestData();
    ...
    private static void query(Connection connection, List<String> data, int index) throws Exception {
        ...
        for (int i = start; i < end; i++) {
            ...
            try (Statement ps =  connection.createStatement()) {
                ...
                ResultSet resultSet = ps.executeQuery(String.format(SQL, data.get(i)));
